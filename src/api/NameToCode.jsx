...
function NameToCode(stateName) {
  ...
  else if(stateName === 'American Samoa'){ return 'as'}
  else if(stateName === 'District of Columbia'){ return 'dc'}
  else if(stateName === 'Guam'){ return 'gu'}
  else if(stateName === 'Northern Mariana Islands'){ return 'mp'}
  else if(stateName === 'Puerto Rico'){ return 'pr'}
  else if(stateName === 'US Virgin Islands'){ return 'vi'}
}
