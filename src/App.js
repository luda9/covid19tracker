...
class App extends React.Component {
  ...
  handleStateChange = async (state) => {
    ...
    const { data, state } = this.state;
        ...
        <Routes>
          <Route path="/covid19tracker" element={
            <>
              <Navbar />
              <Banner />
              <Bar />
              ...
              <TrackerSection />
              <Footer />
              <Helmet><title>Covid Tracker - Home</title></Helmet>
            </>}
          />
          <Route path="/covid19tracker/statistics" element={
          <>
            <Navbar />
            <Cards data={data}/>
            ...
            <Footer />
            <Helmet><title>Covid Tracker - Statistics</title></Helmet>
          </>}/>
        </Routes>
			</div>
			)
